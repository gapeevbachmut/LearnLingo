import{i as b,g as h,c as d,b as i,s as y,d as g,u as v,e as w,o as k}from"./vendor-CJFyyV97.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))a(o);new MutationObserver(o=>{for(const s of o)if(s.type==="childList")for(const n of s.addedNodes)n.tagName==="LINK"&&n.rel==="modulepreload"&&a(n)}).observe(document,{childList:!0,subtree:!0});function r(o){const s={};return o.integrity&&(s.integrity=o.integrity),o.referrerPolicy&&(s.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?s.credentials="include":o.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function a(o){if(o.ep)return;o.ep=!0;const s=r(o);fetch(o.href,s)}})();const x=new Date;document.querySelector(".footer-date");const E=document.querySelector(".date-year");E.textContent=x.getFullYear();const M=`<svg xmlns="http://www.w3.org/2000/svg" aria-hidden="true" style="position:absolute;width:0;height:0;overflow:hidden">
  <defs>
...
`;function S(){const e=document.createElement("svg");e.style.display="none",e.innerHTML=M,document.body.prepend(e)}function L(){document.addEventListener("click",e=>{const t=e.target.closest(".password-toggle");if(!t)return;const r=t.closest(".password-box");if(!r)return;const a=r.querySelector("input"),o=t.querySelector("use");if(!a||!o)return;const s=a.type==="password";a.type=s?"text":"password",o.setAttribute("href",s?"#icon-eye":"#icon-eye-off"),t.setAttribute("aria-label",s?"Hide password":"Show password")})}const q={apiKey:"AIzaSyBM5Y6QM2r6WXTF8zM7dWPy11UsmUn6HlI",authDomain:"learnlingo-auth-320f9.firebaseapp.com",projectId:"learnlingo-auth-320f9",storageBucket:"learnlingo-auth-320f9.firebasestorage.app",messagingSenderId:"1060134815936",appId:"1:1060134815936:web:65e14830a23616ff3e0525"},A=b(q),c=h(A),z=d({username:i().required("Name is required").min(3,"Minimum 3 characters").max(30,"Max 30 characters"),email:i().required("Email is required").email("Enter a valid email, for example: user@gmail.com"),phoneNumber:i().required("Phone is required").matches(/^\+?\d{10,14}$/,"Phone format: +380XXXXXXXXX").transform(e=>e.replace(/\s|-/g,""))}),C=d({email:i().required("Email is required").email("Enter a valid email, for example: user@gmail.com"),password:i().required("Password is required").min(8,"Minimum 8 characters").max(30,"Max 30 characters")}),B=d({username:i().required("Name is required").min(3,"Minimum 3 characters").max(30,"Max 30 characters"),email:i().required("Email is required").email("Enter a valid email, for example: user@gmail.com"),password:i().required("Password is required").min(8,"Minimum 8 characters").max(30,"Max 30 characters")});function m(e){const t={};e.inner.forEach(r=>{t[r.path]=r.message}),Object.entries(t).forEach(([r,a])=>{const o=document.querySelector(`[name="${r}"]`);if(!o)return;let s=o.nextElementSibling;(!s||!s.classList.contains("error"))&&(s=document.createElement("p"),s.classList.add("error"),o.after(s)),s.textContent=a})}function O(e){const t=document.querySelector(".form-lesson");t&&t.addEventListener("submit",async r=>{r.preventDefault(),t.querySelectorAll(".error").forEach(s=>s.remove());const a=new FormData(t),o=Object.fromEntries(a.entries());try{await z.validate(o,{abortEarly:!1}),console.log("BOOKING-FORM DATA:",o),e()}catch(s){m(s)}})}async function P(e,t){return(await y(c,e,t)).user}function I(e){const t=document.querySelector(".form-login");t&&t.addEventListener("submit",async r=>{r.preventDefault(),t.querySelectorAll(".error").forEach(s=>s.remove());const a=new FormData(t),o=Object.fromEntries(a.entries());try{await C.validate(o,{abortEarly:!1}),console.log("LOGIN-FORM DATA:",o),await P(o.email,o.password),e()}catch(s){m(s)}})}function D(){return`
...
<button class="btn-register" type='submit'>Sign Up</button>
  ...
  `}async function T(e,t,r){const a=await g(c,t,r);return await v(a.user,{displayName:e}),a.user}function N(e){const t=document.querySelector(".form-register");t&&t.addEventListener("submit",async r=>{r.preventDefault(),t.querySelectorAll(".error").forEach(s=>s.remove());const a=new FormData(t),o=Object.fromEntries(a.entries());try{await B.validate(o,{abortEarly:!1}),console.log("REGISTER-FORM DATA:",o),await T(o.username,o.email,o.password),e()}catch(s){m(s)}})}const l=document.querySelector("#modal-root");function j(){document.body.classList.add("no-scroll")}function R(){document.body.classList.remove("no-scroll")}function p(e){const{type:t,teacher:r}=e;let a="";switch(t){case"trial":a=H(r);break;case"login":a=D();break;case"register":a=F();break;default:return}l.innerHTML=a,j();const o=l.querySelector(".backdrop"),s=l.querySelector(".closeButton"),n=()=>{l.innerHTML="",R(),document.removeEventListener("keydown",f)},f=u=>{u.key==="Escape"&&n()};o.addEventListener("click",u=>{u.target===o&&n()}),s.addEventListener("click",n),document.addEventListener("keydown",f),t==="trial"&&O(n),t==="login"&&I(n),t==="register"&&N(n)}function X(e){e.innerHTML=`
    <li>
  ...
  `,e.querySelector(".logIn").addEventListener("click",()=>p({type:"login"})),e.querySelector(".register").addEventListener("click",()=>p({type:"register"}))}async function U(){await w(c)}function $(e){return`
    <div class="out-box">
  ...
  <p class="out-text">Hello, ${e.displayName||e.email} </p>
    </div>`}function W(e,t){e.innerHTML=$(t),e.addEventListener("click",async r=>{r.target.classList.contains("logout")&&await U()})}function G(){const e=document.querySelector(".auth-list");e&&k(c,t=>{t?W(e,t):X(e)})}G();S();L();export{p as m};
//# sourceMappingURL=main-CRASTpNa.js.map
