import{c as f,b as i,i as h,g,s as v,d as w,u as k,o as E}from"./vendor-D2CNYbfS.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const e of document.querySelectorAll('link[rel="modulepreload"]'))a(e);new MutationObserver(e=>{for(const r of e)if(r.type==="childList")for(const n of r.addedNodes)n.tagName==="LINK"&&n.rel==="modulepreload"&&a(n)}).observe(document,{childList:!0,subtree:!0});function s(e){const r={};return e.integrity&&(r.integrity=e.integrity),e.referrerPolicy&&(r.referrerPolicy=e.referrerPolicy),e.crossOrigin==="use-credentials"?r.credentials="include":e.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function a(e){if(e.ep)return;e.ep=!0;const r=s(e);fetch(e.href,r)}})();const x=`<svg xmlns="http://www.w3.org/2000/svg" aria-hidden="true" style="position:absolute;width:0;height:0;overflow:hidden">
  <defs>
...
`;function $(){const o=document.createElement("svg");o.style.display="none",o.innerHTML=x,document.body.prepend(o)}const M=f({username:i().required("Name is required").min(3,"Minimum 3 characters").max(30,"Max 30 characters"),email:i().required("Email is required").email("Enter a valid email, for example: user@gmail.com"),phoneNumber:i().required("Phone is required").matches(/^\+?\d{10,14}$/,"Phone format: +380XXXXXXXXX").transform(o=>o.replace(/\s|-/g,""))}),S=f({email:i().required("Email is required").email("Enter a valid email, for example: user@gmail.com"),password:i().required("Password is required").min(8,"Minimum 8 characters").max(30,"Max 30 characters")}),L=f({username:i().required("Name is required").min(3,"Minimum 3 characters").max(30,"Max 30 characters"),email:i().required("Email is required").email("Enter a valid email, for example: user@gmail.com"),password:i().required("Password is required").min(8,"Minimum 8 characters").max(30,"Max 30 characters")});function p(o){const t={};o.inner.forEach(s=>{t[s.path]=s.message}),Object.entries(t).forEach(([s,a])=>{const e=document.querySelector(`[name="${s}"]`);if(!e)return;let r=e.nextElementSibling;(!r||!r.classList.contains("error"))&&(r=document.createElement("p"),r.classList.add("error"),e.after(r)),r.textContent=a})}function q(o){const t=document.querySelector(".form-lesson");t&&t.addEventListener("submit",async s=>{s.preventDefault(),t.querySelectorAll(".error").forEach(r=>r.remove());const a=new FormData(t),e=Object.fromEntries(a.entries());try{await M.validate(e,{abortEarly:!1}),console.log("BOOKING-FORM DATA:",e),o()}catch(r){p(r)}})}const C={apiKey:"AIzaSyBM5Y6QM2r6WXTF8zM7dWPy11UsmUn6HlI",authDomain:"learnlingo-auth-320f9.firebaseapp.com",projectId:"learnlingo-auth-320f9",storageBucket:"learnlingo-auth-320f9.firebasestorage.app",messagingSenderId:"1060134815936",appId:"1:1060134815936:web:65e14830a23616ff3e0525"},z=h(C),y=g(z);async function A(o,t){return(await v(y,o,t)).user}function B(o){const t=document.querySelector(".form-login");t&&t.addEventListener("submit",async s=>{s.preventDefault(),t.querySelectorAll(".error").forEach(r=>r.remove());const a=new FormData(t),e=Object.fromEntries(a.entries());try{await S.validate(e,{abortEarly:!1}),console.log("LOGIN-FORM DATA:",e),await A(e.email,e.password),o()}catch(r){p(r)}})}function D(){return`
...
<button class="btn-register" type='submit'>Sign Up</button>
  ...
  `}async function I(o,t,s){const a=await w(y,t,s);return await k(a.user,{displayName:o}),a.user}function F(o){const t=document.querySelector(".form-register");t&&t.addEventListener("submit",async s=>{s.preventDefault(),t.querySelectorAll(".error").forEach(r=>r.remove());const a=new FormData(t),e=Object.fromEntries(a.entries());try{await L.validate(e,{abortEarly:!1}),console.log("REGISTER-FORM DATA:",e),await I(e.username,e.email,e.password),o()}catch(r){p(r)}})}const l=document.querySelector("#modal-root");function N(){document.body.classList.add("no-scroll")}function T(){document.body.classList.remove("no-scroll")}function c(o){const{type:t,teacher:s}=o;let a="";switch(t){case"trial":a=P(s);break;case"login":a=D();break;case"register":a=O();break;default:return}l.innerHTML=a,N();const e=l.querySelector(".backdrop"),r=l.querySelector(".closeButton"),n=()=>{l.innerHTML="",T(),document.removeEventListener("keydown",b)},b=m=>{m.key==="Escape"&&n()};e.addEventListener("click",m=>{m.target===e&&n()}),r.addEventListener("click",n),document.addEventListener("keydown",b),t==="trial"&&q(n),t==="login"&&B(n),t==="register"&&F(n)}const d=document.querySelector(".logIn"),u=document.querySelector(".register");d&&d.addEventListener("click",o=>{o.preventDefault(),c({type:"login"})});u&&u.addEventListener("click",o=>{o.preventDefault(),c({type:"register"})});E(y,o=>{o?(console.log("name",o.displayName),console.log("Logged in:",o.email)):(d&&d.addEventListener("click",t=>{t.preventDefault(),c({type:"login"})}),u&&u.addEventListener("click",t=>{t.preventDefault(),c({type:"register"})}),console.log("Not logged in"))});const j=new Date;document.querySelector(".footer-date");const X=document.querySelector(".date-year");X.textContent=j.getFullYear();export{$ as i,c as m};
//# sourceMappingURL=footer-DFbkv3eU.js.map
