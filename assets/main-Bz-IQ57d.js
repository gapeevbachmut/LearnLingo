import{i as b,g as y,c as d,b as i,s as g,d as v,u as w,e as k,o as E}from"./vendor-CJFyyV97.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))a(o);new MutationObserver(o=>{for(const s of o)if(s.type==="childList")for(const n of s.addedNodes)n.tagName==="LINK"&&n.rel==="modulepreload"&&a(n)}).observe(document,{childList:!0,subtree:!0});function r(o){const s={};return o.integrity&&(s.integrity=o.integrity),o.referrerPolicy&&(s.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?s.credentials="include":o.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function a(o){if(o.ep)return;o.ep=!0;const s=r(o);fetch(o.href,s)}})();const x={apiKey:"AIzaSyBM5Y6QM2r6WXTF8zM7dWPy11UsmUn6HlI",authDomain:"learnlingo-auth-320f9.firebaseapp.com",projectId:"learnlingo-auth-320f9",storageBucket:"learnlingo-auth-320f9.firebasestorage.app",messagingSenderId:"1060134815936",appId:"1:1060134815936:web:65e14830a23616ff3e0525"},M=b(x),c=y(M),S=d({username:i().required("Name is required").min(3,"Minimum 3 characters").max(30,"Max 30 characters"),email:i().required("Email is required").email("Enter a valid email, for example: user@gmail.com"),phoneNumber:i().required("Phone is required").matches(/^\+?\d{10,14}$/,"Phone format: +380XXXXXXXXX").transform(e=>e.replace(/\s|-/g,""))}),L=d({email:i().required("Email is required").email("Enter a valid email, for example: user@gmail.com"),password:i().required("Password is required").min(8,"Minimum 8 characters").max(30,"Max 30 characters")}),q=d({username:i().required("Name is required").min(3,"Minimum 3 characters").max(30,"Max 30 characters"),email:i().required("Email is required").email("Enter a valid email, for example: user@gmail.com"),password:i().required("Password is required").min(8,"Minimum 8 characters").max(30,"Max 30 characters")});function m(e){const t={};e.inner.forEach(r=>{t[r.path]=r.message}),Object.entries(t).forEach(([r,a])=>{const o=document.querySelector(`[name="${r}"]`);if(!o)return;let s=o.nextElementSibling;(!s||!s.classList.contains("error"))&&(s=document.createElement("p"),s.classList.add("error"),o.after(s)),s.textContent=a})}function A(e){const t=document.querySelector(".form-lesson");t&&t.addEventListener("submit",async r=>{r.preventDefault(),t.querySelectorAll(".error").forEach(s=>s.remove());const a=new FormData(t),o=Object.fromEntries(a.entries());try{await S.validate(o,{abortEarly:!1}),console.log("BOOKING-FORM DATA:",o),e()}catch(s){m(s)}})}async function C(e,t){return(await g(c,e,t)).user}function z(e){const t=document.querySelector(".form-login");t&&t.addEventListener("submit",async r=>{r.preventDefault(),t.querySelectorAll(".error").forEach(s=>s.remove());const a=new FormData(t),o=Object.fromEntries(a.entries());try{await L.validate(o,{abortEarly:!1}),console.log("LOGIN-FORM DATA:",o),await C(o.email,o.password),e()}catch(s){m(s)}})}function B(){return`
...
<button class="btn-register" type='submit'>Sign Up</button>
  ...
  `}async function T(e,t,r){const a=await v(c,t,r);return await w(a.user,{displayName:e}),a.user}function I(e){const t=document.querySelector(".form-register");t&&t.addEventListener("submit",async r=>{r.preventDefault(),t.querySelectorAll(".error").forEach(s=>s.remove());const a=new FormData(t),o=Object.fromEntries(a.entries());try{await q.validate(o,{abortEarly:!1}),console.log("REGISTER-FORM DATA:",o),await T(o.username,o.email,o.password),e()}catch(s){m(s)}})}const l=document.querySelector("#modal-root");function D(){document.body.classList.add("no-scroll")}function F(){document.body.classList.remove("no-scroll")}function p(e){const{type:t,teacher:r}=e;let a="";switch(t){case"trial":a=P(r);break;case"login":a=B();break;case"register":a=O();break;default:return}l.innerHTML=a,D();const o=l.querySelector(".backdrop"),s=l.querySelector(".closeButton"),n=()=>{l.innerHTML="",F(),document.removeEventListener("keydown",f)},f=u=>{u.key==="Escape"&&n()};o.addEventListener("click",u=>{u.target===o&&n()}),s.addEventListener("click",n),document.addEventListener("keydown",f),t==="trial"&&A(n),t==="login"&&z(n),t==="register"&&I(n)}function H(e){e.innerHTML=`
    <li>
  ...
  `,e.querySelector(".logIn").addEventListener("click",()=>p({type:"login"})),e.querySelector(".register").addEventListener("click",()=>p({type:"register"}))}async function N(){await k(c)}function U(e){return`
    <div class="out-box">
  ...
  <p class="out-text">Hello, ${e.displayName||e.email} </p>
    </div>`}function j(e,t){e.innerHTML=U(t),e.addEventListener("click",async r=>{r.target.classList.contains("logout")&&await N()})}let h=null;function R(){const e=document.querySelector(".auth-list");e&&E(c,t=>{h=t||null,t?j(e,t):H(e)})}function _(){return h}const X=new Date;document.querySelector(".footer-date");const $=document.querySelector(".date-year");$.textContent=X.getFullYear();const W=`<svg xmlns="http://www.w3.org/2000/svg" aria-hidden="true" style="position:absolute;width:0;height:0;overflow:hidden">
  <defs>
