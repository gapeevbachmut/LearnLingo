import{g as o,m as c}from"./main-v5fm1CT6.js";import{i as h,a as p}from"./vendor-DSAFy7k_.js";function l(e){return JSON.parse(localStorage.getItem(`favorites_${e}`))||[]}function u(e,t){localStorage.setItem(`favorites_${e}`,JSON.stringify(t))}function v(e,t){const s=l(e),a=s.indexOf(t);return a===-1?s.push(t):s.splice(a,1),u(e,s),s}function d(e,t){return l(e).includes(t)}function g(e){return`
...
//# sourceMappingURL=teachers-api-Bl3wWxQl.js.map
