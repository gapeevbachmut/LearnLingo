import{i as y,g,c as m,b as i,s as v,d as w,u as k,e as E,o as x}from"./vendor-CJFyyV97.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))a(o);new MutationObserver(o=>{for(const s of o)if(s.type==="childList")for(const n of s.addedNodes)n.tagName==="LINK"&&n.rel==="modulepreload"&&a(n)}).observe(document,{childList:!0,subtree:!0});function r(o){const s={};return o.integrity&&(s.integrity=o.integrity),o.referrerPolicy&&(s.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?s.credentials="include":o.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function a(o){if(o.ep)return;o.ep=!0;const s=r(o);fetch(o.href,s)}})();const M={apiKey:"AIzaSyBM5Y6QM2r6WXTF8zM7dWPy11UsmUn6HlI",authDomain:"learnlingo-auth-320f9.firebaseapp.com",projectId:"learnlingo-auth-320f9",storageBucket:"learnlingo-auth-320f9.firebasestorage.app",messagingSenderId:"1060134815936",appId:"1:1060134815936:web:65e14830a23616ff3e0525"},S=y(M),u=g(S),L=m({username:i().required("Name is required").min(3,"Minimum 3 characters").max(30,"Max 30 characters"),email:i().required("Email is required").email("Enter a valid email, for example: user@gmail.com"),phoneNumber:i().required("Phone is required").matches(/^\+?\d{10,14}$/,"Phone format: +380XXXXXXXXX").transform(e=>e.replace(/\s|-/g,""))}),q=m({email:i().required("Email is required").email("Enter a valid email, for example: user@gmail.com"),password:i().required("Password is required").min(8,"Minimum 8 characters").max(30,"Max 30 characters")}),A=m({username:i().required("Name is required").min(3,"Minimum 3 characters").max(30,"Max 30 characters"),email:i().required("Email is required").email("Enter a valid email, for example: user@gmail.com"),password:i().required("Password is required").min(8,"Minimum 8 characters").max(30,"Max 30 characters")});function f(e){const t={};e.inner.forEach(r=>{t[r.path]=r.message}),Object.entries(t).forEach(([r,a])=>{const o=document.querySelector(`[name="${r}"]`);if(!o)return;let s=o.nextElementSibling;(!s||!s.classList.contains("error"))&&(s=document.createElement("p"),s.classList.add("error"),o.after(s)),s.textContent=a})}function C(e){const t=document.querySelector(".form-lesson");t&&t.addEventListener("submit",async r=>{r.preventDefault(),t.querySelectorAll(".error").forEach(s=>s.remove());const a=new FormData(t),o=Object.fromEntries(a.entries());try{await L.validate(o,{abortEarly:!1}),console.log("BOOKING-FORM DATA:",o),e()}catch(s){f(s)}})}async function z(e,t){return(await v(u,e,t)).user}function B(e){const t=document.querySelector(".form-login");t&&t.addEventListener("submit",async r=>{r.preventDefault(),t.querySelectorAll(".error").forEach(s=>s.remove());const a=new FormData(t),o=Object.fromEntries(a.entries());try{await q.validate(o,{abortEarly:!1}),console.log("LOGIN-FORM DATA:",o),await z(o.email,o.password),e()}catch(s){f(s)}})}function T(){return`
...
<button class="btn-register" type='submit'>Sign Up</button>
  ...
  `}async function H(e,t,r){const a=await w(u,t,r);return await k(a.user,{displayName:e}),a.user}function F(e){const t=document.querySelector(".form-register");t&&t.addEventListener("submit",async r=>{r.preventDefault(),t.querySelectorAll(".error").forEach(s=>s.remove());const a=new FormData(t),o=Object.fromEntries(a.entries());try{await A.validate(o,{abortEarly:!1}),console.log("REGISTER-FORM DATA:",o),await H(o.username,o.email,o.password),e()}catch(s){f(s)}})}const c=document.querySelector("#modal-root");function I(){document.body.classList.add("no-scroll")}function D(){document.body.classList.remove("no-scroll")}function h(e){const{type:t,teacher:r}=e;let a="";switch(t){case"trial":a=P(r);break;case"login":a=T();break;case"register":a=O();break;default:return}c.innerHTML=a,I();const o=c.querySelector(".backdrop"),s=c.querySelector(".closeButton"),n=()=>{c.innerHTML="",D(),document.removeEventListener("keydown",p)},p=d=>{d.key==="Escape"&&n()};o.addEventListener("click",d=>{d.target===o&&n()}),s.addEventListener("click",n),document.addEventListener("keydown",p),t==="trial"&&C(n),t==="login"&&B(n),t==="register"&&F(n)}function N(e){e.innerHTML=`
    <li>
  ...
  `,e.querySelector(".logIn").addEventListener("click",()=>h({type:"login"})),e.querySelector(".register").addEventListener("click",()=>h({type:"register"}))}async function R(){await E(u)}function U(e){return`
    <div class="out-box">
  ...
  <p class="out-text">Hello, ${e.displayName||e.email} </p>
    </div>`}function j(e,t,r){r.innerHTML=`
    <li><a href="./favorites.html">❤️ Favorites</a></li>
    <li>
      <button class="logout-btn">Log out</button>
    </li>
    <li class="user-name">Hello, ${t.displayName||t.email}</li>
  `,e.innerHTML=U(t),e.addEventListener("click",async a=>{a.target.classList.contains("logout")&&await R()})}let l=null,b=[];function X(){const e=document.querySelector(".auth-list");e&&x(u,t=>{l=t||null,b.forEach(r=>r(l)),t?j(e,t):N(e)})}function Q(){return l}function J(e){b.push(e),l!==null&&e(l)}const $=new Date;document.querySelector(".footer-date");const W=document.querySelector(".date-year");W.textContent=$.getFullYear();const V=`<svg xmlns="http://www.w3.org/2000/svg" aria-hidden="true" style="position:absolute;width:0;height:0;overflow:hidden">
  <defs>
...
`;function Y(){const e=document.createElement("svg");e.style.display="none",e.innerHTML=V,document.body.prepend(e)}function G(){document.addEventListener("click",e=>{const t=e.target.closest(".password-toggle");if(!t)return;const r=t.closest(".password-box");if(!r)return;const a=r.querySelector("input"),o=t.querySelector("use");if(!a||!o)return;const s=a.type==="password";a.type=s?"text":"password",o.setAttribute("href",s?"#icon-eye":"#icon-eye-off"),t.setAttribute("aria-label",s?"Hide password":"Show password")})}function K(){const e=document.querySelector(".scroll-top");if(!e)return;const t=()=>{window.scrollY>350?e.classList.remove("is-hidden"):e.classList.add("is-hidden")};window.addEventListener("scroll",t),t();const r=()=>window.scrollTo({top:0,behavior:"smooth"});e.addEventListener("click",r)}X();Y();G();K();export{Q as g,h as m,J as o};
//# sourceMappingURL=main-C0wBvBBP.js.map
